...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7401e92b6ca42fdc25d1567e356d0800) *)
(*
...
let setup_t =
  {
                 ...
                 CustomPlugin.cmd_main =
                   [
                      (OASISExpr.EBool true,
                        ("$unittest", ["inline-test-runner"; "dummy"]))
                   ];
            ...
            [
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("mtime", None);
                           FindlibPackage ("mtime.clock.os", None);
                           FindlibPackage ("cstruct", None);
                           FindlibPackage ("dprle", None);
                           FindlibPackage ("frenetic", None);
                           FindlibPackage ("frenetic.async", None);
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      bs_build =
                        [
                           ...
                           (OASISExpr.EFlag "is_native", true)
                        ];
                   ...
                   {exec_custom = false; exec_main_is = "Merlin.ml"});
               Test
                 ({
                     cs_name = "all_tests";
                     cs_data = PropList.Data.create ();
     ...
     oasis_digest = Some "\152\143n\181\005\194:\r\139\205a\221%\138\195w";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
